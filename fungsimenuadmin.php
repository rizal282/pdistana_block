<?php
          if(isset($_POST["menu"])){
            ...
            }elseif($menu == "logoutadmin"){
              session_destroy();

              header("location:".$url);
            }elseif($menu == "set_menustaff"){
              include_once "proses/proses_setmenu_staff.php";
            }elseif($menu == "proseshapusmenustaff"){
              include_once "proses/proses_hapusmenu_staff.php";
            }
          }else{
            include_once "home.php";
          }
