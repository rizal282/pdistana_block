<?php
	...
	$pdf->Cell(130,7,'SLIP GAJI KARYAWAN HARIAN',0,1,'C');

	// Memberikan space kebawah agar tidak terlalu rapat
	$pdf->Cell(10,7,'',0,1);

	$getgajikaryawanharian = "select * from gaji_karyawanharian order by id_gajiharian desc limit 1";
	...
	// $pdf->Cell(30,6,$rowgajiharian['pekerjaan'],1,1);
	$pdf->Cell(40,6,'Total Gaji',1,0);
